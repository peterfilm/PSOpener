...
class UI(object):
    def setupUi(self, Form):
        ...
        self.pushButton_choiseYourPhotos.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pushButton_choiseYourPhotos.setObjectName(
            "pushButton_choiseYourPhotos")
        self.horizontalLayout_2.addWidget(self.pushButton_choiseYourPhotos)
        self.pushButton_loadList = QtWidgets.QPushButton(Form)
        self.pushButton_loadList.setMinimumSize(QtCore.QSize(150, 33))
        self.pushButton_loadList.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.pushButton_loadList.setObjectName("pushButton_loadList")
        self.horizontalLayout_2.addWidget(self.pushButton_loadList)
        ...
        self.label_countPhotos.setAlignment(
        ...
        self.pushButton_saveList.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", conf['PROGRAM_NAME']))
        ...
        self.pushButton_choiseYourPhotos.setToolTip(_translate(
            "Form", "<html><head/><body><p>Горячие клавиши:<br/>Ctrl + SHIFT + O</p></body></html>"))
        self.pushButton_choiseYourPhotos.setText(
            _translate("Form", "Выбрать фотографии"))
        self.pushButton_choiseYourPhotos.setShortcut(
            _translate("Form", "Ctrl+Shift+O"))
        self.pushButton_loadList.setToolTip(_translate(
            "Form", "<html><head/><body><p>Горячие клавиши:<br/>Ctrl + L</p></body></html>"))
        self.pushButton_loadList.setText(
            _translate("Form", "Загрузить список"))
        self.pushButton_loadList.setShortcut(_translate("Form", "Ctrl+L"))
        ...
        self.pushButton_saveList.setToolTip(_translate(
            "Form", "<html><head/><body><p>Горячие клавиши:<br/>Ctrl + S</p></body></html>"))
        self.pushButton_saveList.setText(
            _translate("Form", "Сохранить список"))
