...
class UI(object):
    def setupUi(self, Form):
        ...
        self.pushButton_loadList.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_loadList.setToolTip(_translate("Form", "<html><head/><body><p>Горячие клавиши:<br/>Ctrl + L</p></body></html>"))
        self.pushButton_loadList.setText(_translate("Form", "Загрузить список"))
